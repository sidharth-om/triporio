...
export default function LoginPage() {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      navigate(result.user.role === 'admin' ? '/admin' : '/trip-plan');
    }
  };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-16 left-10 max-w-md">
          ...
          <p className="text-slate-300">Login to access personalized trip planning, wishlist, and WhatsApp booking.</p>
        </div>
      </div>
      ...
      <div className="flex-1 lg:max-w-md flex items-center justify-center px-6 py-16">
        ...
        >
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-display text-white font-bold text-lg">Explore North Kerala</span>
          </div>

          <h1 className="font-display text-3xl text-white font-bold mb-2">Welcome back</h1>
          <p className="text-slate-400 mb-8">Sign in to continue planning your Kerala trip</p>
          ...
          <div className="mt-6 p-4 glass rounded-xl text-xs text-slate-400">
            ...
            <p>Email: admin@explorenorthkerala.com</p>
