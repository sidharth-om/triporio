    ...
    <div className="min-h-screen pt-24 pb-20 px-4">
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          >
            Discover the Soul of <span className="gradient-text">North Kerala</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Explore North Kerala is a passionate team of local experts dedicated to uncovering the hidden gems, vibrant culture, and untouched nature of Kerala's northern districts. We believe in authentic travel experiences that connect you with the soul of our land.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: FiMap, title: "50+ Destinations", desc: "Curated hidden gems across North Kerala." },
