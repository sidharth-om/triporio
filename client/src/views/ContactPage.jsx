...
export default function ContactPage() {
  ...
  const handleWhatsApp = (e) => {
    ...
    const text = `Hi! My name is ${name || 'Visitor'}. ${message || 'I would like to know more about the tour packages.'}`;
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400">info@triporio.com</p>
              </div>
            </motion.div>
          </div>
            ...
            <form className="space-y-4" onSubmit={handleWhatsApp}>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="input-dark text-white min-h-[150px] resize-none" 
